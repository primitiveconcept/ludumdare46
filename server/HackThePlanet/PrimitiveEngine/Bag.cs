namespace PrimitiveEngine
{
	...
	public class Bag<T> : IEnumerable<T>
	{
		...
		/// <summary>
		/// Adds a range of elements into this bag.
		/// </summary>
		...
		/// <summary>
		/// Determines whether bag contains the specified element.
		/// </summary>
		...
		/// If the Bag does not contain the element, it is unchanged.
		...
		private void Grow()
		{
			Grow((int)(this.elements.Length * 1.5) + 1);
		}
