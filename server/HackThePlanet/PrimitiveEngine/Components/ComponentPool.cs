namespace PrimitiveEngine
{
        ...
        where T : ComponentPoolable
    {
            ...
            Type innerType)
        {
            ...
            if (initialSize < 1)
            {
                throw new ArgumentOutOfRangeException(
                    paramName: nameof(initialSize), 
                    message: $"{nameof(initialSize)} must be at least 1.");
            }

            if (resizePool < 1)
            {
                throw new ArgumentOutOfRangeException(
                    paramName: nameof(resizePool), 
                    message: $"{nameof(resizePool)} must be at least 1.");
            }
            ...
            this.allocate = 
                allocateFunc != null 
                    ? allocateFunc 
                    : throw new ArgumentNullException(nameof(allocateFunc));
        }
        #endregion
        ...
        /// <summary>
        /// Returns a valid object at the given index.
        /// The index must fall in the range of [0, ValidCount].
        /// </summary>
            ...
            get
            {
                ...
                if (index < this.InvalidCount || index >= this.components.Length)
                {
                    throw new ArgumentOutOfRangeException(
                        ...
                        message: "The index must be less than or equal to ValidCount.");
                }
        ...
        public void CleanUp()
        {
            ...
            {
                // otherwise if we're not at the start of the invalid objects,
                // we have to move the object to the invalid object section of the array
        ...
        public T New()
        {
            ...
            if (this.InvalidCount == 0)
            {
                ...
                // Create a new array with some more slots
                // and copy over the existing components.
            ...
            if (result == null)
            {
                ...
                this.components[this.InvalidCount] = 
                    result != null 
                        ? result 
